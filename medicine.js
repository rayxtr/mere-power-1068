...
fetch("https://636bd26d7f47ef51e13b5902.mockapi.io/products").then((res)=>res.json()).then((data)=>{console.log(data);bag=data; displayproduct(data)}).catch((err)=>console.log(err));
